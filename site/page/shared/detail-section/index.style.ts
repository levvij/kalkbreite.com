import { child, display, alignItems, flexWrap, gap, width, min, percentage, rem, marginBottom, fontSize, lineHeight, height, maxWidth, objectFit, flexGrow, justifyContent, marginRight, style, select, textDecorationLine, attribute } from "@acryps/style";
