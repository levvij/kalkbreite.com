	...
	child('ui-canvas') (
		...
		child('ui-crop') (
			...
			attribute('ui-property', 'top') (
				...
				child('ui-handle') (
					top(percentage(100).subtract(handleSize))
				)
			),
			...
			attribute('ui-property', 'left') (
				...
				child('ui-handle') (
					left(percentage(100).subtract(handleSize))
				)
			),
			...
			attribute('ui-property', 'right') (
				...
				child('ui-handle') (
					right(percentage(100).subtract(handleSize))
				)
			),
			...
			attribute('ui-property', 'bottom') (
				...
				child('ui-handle') (
					bottom(percentage(100).subtract(handleSize))
				)
			),
